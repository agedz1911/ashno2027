<div class="flex flex-col items-center">
    <div class="stats stats-vertical lg:stats-horizontal shadow w-full max-w-xl">
        <div class="stat">
            <div class="stat-figure text-[#C0809A]">
    ...
    <div class="stats stats-vertical lg:stats-horizontal shadow">
        ...
        <div class="stat">
            ...
            <div class="stat-desc hover:underline hover:text-primary"><a href="mailto:ashno2027@pharma-pro.com">ashno2027@pharma-pro.com</a></div>
        </div>
        ...
        <div class="stat">
            ...
            <div class="stat-desc">
                <a class="hover:underline hover:text-primary" target="_blank" href="https://wa.me/+6282277832431"> +62 822-7783-2431 (Nova) </a> <br>
        ...
        <div class="stat">
            ...
            <div class="stat-desc">
                {{-- <a class="hover:underline hover:text-primary" target="_blank" href="https://www.instagram.com/asmiua/"> @asmiua </a> --}}
