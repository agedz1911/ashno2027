    ...
    <div class="relative">
        ...
        <div class="mx-auto w-full px-5 sm:px-8 lg:px-12">
            ...
            <div class="grid gap-2 lg:grid-cols-3">
                ...
                <article class="flex h-full flex-col overflow-hidden border border-white/20 bg-[#075a99] rounded-md shadow-[0_18px_45px_rgba(11,20,90,0.2)]">
                    <div class="flex-1 p-7 sm:p-9">
                        <p class="mb-4 text-xs font-bold uppercase tracking-[0.16em] text-white">{{ $welcomeMessage->title }}</p>
                        ...
                        <div class="flex items-center justify-between gap-4 flex-col">
                            <div class="flex relative flex-col md:flex-row min-w-0 items-center gap-4">
                                ...
                                <div class="min-w-0 p-6 sm:p-7 z-10">
                                    ...
                                    <h3 class="mt-1 text-lg lg:text-base xl:text-lg font-bold leading-tight text-white sm:text-xl">{{ $welcomeMessage->name }}</h3>
                            ...
                            <a href="{{ route('welcome-message') }}#welcome-message-{{ $welcomeMessage->id }}" class="btn btn-outline btn-primary mb-5 text-white">Read more</a>
                        </div>
                    </div>
                </article>
                @endforeach
